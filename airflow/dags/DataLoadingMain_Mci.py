...
with DAG(
    dag_id = 'DataLoadingMain_Mci_test',
    ...
    send_email1 = EmailOperator( 
        ...
        html_content='Run dataloader node completed with workflow_run_id of {{ var.value.workflow_run_id}}, file count: {{ ti.xcom_pull(task_ids="file_count", key="return_value") }}' 
    ) 
